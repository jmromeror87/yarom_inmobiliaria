...
class PropertyImportReportExporter
{
    ...
    public function stream(array $filas, string $filename = 'reporte_importacion_inmuebles.xlsx'): \Symfony\Component\HttpFoundation\StreamedResponse
    {
    ...
    public function build(array $filas): Spreadsheet
    {
        ...
        $headers = ['Fila Excel', 'Documento propietario', 'Dirección', 'Estado', 'Motivo'];
        ...
        foreach ($filas as $f) {
            ...
            $sheet->setCellValue("C{$row}", $f['direccion']);
