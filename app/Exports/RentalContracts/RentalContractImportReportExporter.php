...
class RentalContractImportReportExporter
{
    ...
    public function stream(array $filas, string $filename = 'reporte_importacion_contratos_arriendo.xlsx'): \Symfony\Component\HttpFoundation\StreamedResponse
    {
    ...
    public function build(array $filas): Spreadsheet
    {
        ...
        $headers = ['Fila Excel', 'Documento arrendatario', 'Inmueble', 'Estado', 'Motivo'];
        ...
        foreach ($filas as $f) {
            ...
            $sheet->setCellValue("B{$row}", $f['arrendatario_documento']);
