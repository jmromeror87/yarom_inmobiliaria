...
<div class="lm-wrap">
    ...
    <div class="lm-empty">
        ...
        <div class="lm-empty-text">Selecciona una cuenta PUC para ver sus movimientos.</div>
    </div>
    @else
    ...
    <div class="lm-cuenta-header">
        <div>
            <div class="lm-cuenta-kicker">Cuenta PUC</div>
            <div class="lm-cuenta-codigo">{{ $cuenta?->codigo }}</div>
            <div class="lm-cuenta-nombre">{{ $cuenta?->nombre }}</div>
        ...
        <div class="lm-saldo-block">
            ...
            <div class="lm-saldo-valor" style="{{ $saldoFinal >= 0 ? 'color:#86efac' : 'color:#fca5a5' }}">
                {{ $fmt(abs($saldoFinal)) }}
                {{ $saldoFinal >= 0 ? ($cuenta?->naturaleza === 'debito' ? '(D)' : '(C)') : '(NEG)' }}
            </div>
        </div>
    </div>
    ...
    <div class="lm-stats">
        ...
        <div class="lm-stat">
            <div class="lm-stat-label">Total débitos</div>
            <div class="lm-stat-value lm-deb">{{ $fmt($totalDeb) }}</div>
        </div>
        <div class="lm-stat">
            <div class="lm-stat-label">Total créditos</div>
