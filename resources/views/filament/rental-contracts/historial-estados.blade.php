...
$labels = [
    ...
    'enviado_arrendatario' => ['label'=>'Enviado arrendatario','icon'=>'📤','color'=>'#2563eb'],
    'aprobado'             => ['label'=>'Aprobado',            'icon'=>'✅','color'=>'#16a34a'],
...
@endforeach
<div style="text-align:center;font-size:11px;color:#94a3b8;padding:6px 0;">{{ $historial->count() }} cambio(s) registrado(s)</div>
</div>
