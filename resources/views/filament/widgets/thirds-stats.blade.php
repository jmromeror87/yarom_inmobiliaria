@php
    $cards = [
        ...
        [
            'label'  => 'Propietarios',
            'sub'    => $arrendatarios . ' arrendatarios',
            'value'  => $propietarios,
            'color'  => '#16a34a',
            'bg'     => '#f0fdf4',
        ...
        [
            ...
            'color'  => '#E11D48',
            'bg'     => '#fef2f2',
            'action' => 'filter:estado_crediticio:aprobado',
            'icon'   => '<svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.7"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
        ],
        [
            'label'  => 'Activos',
