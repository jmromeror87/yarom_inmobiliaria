...
$reportes = [
    ...
    [
        'titulo'  => 'Estado de Cuenta por Arrendatario',
        'desc'    => 'Un renglón por período de cada inquilino: qué ha pagado y qué debe, por contrato e inmueble.',
        'color'   => '#0E7490',
        'colorBg' => '#ecfeff',
        'span'    => 2,
        ...
        'nota'    => 'Estado actual · todos los períodos, sin importar el filtro de mes/año',
        'botones' => [['label'=>'Excel','r'=>'estado_cuenta','t'=>'excel','bg'=>'#16a34a','bg2'=>'#4ade80','icon'=>'M9 13.5l3 3m0 0l3-3m-3 3v-6m1.06-4.19l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.061-.44z']],
    ],
    [
