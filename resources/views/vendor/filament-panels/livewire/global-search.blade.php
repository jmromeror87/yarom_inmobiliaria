...
<div class="yr-search-ctn" x-data="{}">
    ...
    >
        ...
        {{-- En mobile el input colapsa a width:0 (solo se ve el ícono) y se
             expande con :focus-within — pero en touch no hay nada que tocar
             para darle foco al input, así que el ícono se veía "roto". Se
             enfoca el input al tocar cualquier parte del círculo. --}}
        <div class="yr-search-field" x-id="['search']" x-on:click="document.getElementById($id('search'))?.focus()">
